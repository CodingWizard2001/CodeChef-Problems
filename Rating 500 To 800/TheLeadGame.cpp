...
int main(){
    ...
    cin>>testCase;
    int sum1 = 0,sum2 = 0,diff = 0,lead = 0,winner;
    while(testCase--){
        int score1,score2;
        cout<<"Enter the player 1 score : ";
        cin>>score1;
        cout<<"Enter the player 2 score : ";
        cin>>score2;
        sum1 += score1;
        sum2 += score2;
        if(sum1 > sum2){
    ...
    cout<<"The winner is player "<<winner<<" and the lead was : "<<lead<<endl;
}