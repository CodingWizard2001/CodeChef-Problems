...
int main() {
    ...
    cin>>testCase;
    while(testCase--){
        int noOfCups,initialPosition,noOfFlips;

        // cout<<"Enter the no. of cups : ";
        cin>>noOfCups;

        // cout<<"Enter the initial position of cups : ";
        cin>>initialPosition;
        ...
        while(noOfFlips--){
            ...
            // cout<<"Enter the left position : ";
            cin>>left;

            // cout<<"Enter the right position : ";
            cin>>right;

            if((initialPosition >= left) && (initialPosition <= right)) initialPosition = (left + right) - initialPosition;
        }
